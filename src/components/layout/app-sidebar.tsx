...
export function AppSidebar() {
  return (
    <aside className="bg-sidebar text-sidebar-foreground sticky top-0 hidden h-dvh flex-col border-r p-4 lg:flex">
      <AppBrand className="mx-1 mb-7 shrink-0" />

      <Link
        href={newTransactionItem.href}
        className="focus-visible:ring-sidebar-ring mb-5 flex min-h-11 shrink-0 items-center justify-center gap-2 rounded-xl bg-emerald-700 px-4 py-2 text-sm font-semibold text-white shadow-sm transition-colors outline-none hover:bg-emerald-800 focus-visible:ring-3 dark:bg-emerald-500 dark:text-emerald-950 dark:hover:bg-emerald-400"
      >
      ...
      <div className="border-sidebar-border mt-5 flex shrink-0 items-start gap-3 border-t px-2 pt-4">
        <ShieldCheck
          aria-hidden="true"
